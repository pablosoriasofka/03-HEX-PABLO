...
public class BuysUseCase  {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BuysUseCase.class);
    ...
    public BuysUseCase(IBankTransactionRepository repository, IAccountRepository accountRepository, IBankRepository bankRepository) {
